<template>
  <div>
    ...
    <div class="mb-8">
      <div class="mb-4">
        <h1 class="text-2xl font-semibold text-gray-900">Role & Permission Management</h1>
        <p class="mt-2 text-sm text-gray-600">Manage roles, permissions, and their relationships</p>
      </div>
    ...
    <!-- Roles Tab -->
    <div v-if="currentTab === 'roles'" class="bg-white shadow rounded-lg overflow-hidden mb-6">
    ...
    <!-- Permissions Tab -->
    <div v-if="currentTab === 'permissions'" class="bg-white shadow rounded-lg overflow-hidden mb-6">
      <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
    ...
    <!-- Assignments Tab -->
    <div v-if="currentTab === 'assignments'" class="bg-white shadow rounded-lg overflow-hidden mb-6">
      <div class="px-6 py-4 border-b border-gray-200">
        <h2 class="text-lg font-medium text-gray-900">Role-Permission Assignments</h2>
      </div>
          ...
          <div class="border rounded-md p-4">
            ...
            <div class="space-y-2">
              ...
              >
                ...
                />
                <span class="text-sm text-gray-900">{{ permission.permission_name }}</span>
              </label>
            </div>
            <div class="mt-4">
              <button
